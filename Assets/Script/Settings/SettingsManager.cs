    ...
    public static partial class SettingsManager
    {
        ...
        public static readonly List<Tab> DisplayedSettingsTabs = new()
        {
            ...
            new MetadataTab("Graphics", icon: "Display", new TrackPreviewBuilder())
            {
                ...
                nameof(Settings.GemHighwayGlowIntensity),
                nameof(Settings.GemHighwayGlowWidth),
                nameof(Settings.GemHighwayGlowWideWidth),
                nameof(Settings.GemHighwayGlowLength),
                nameof(Settings.GemHighwayGlowForwardShift),
