    ...
    public static partial class SettingsManager
    {
        public class SettingContainer
        {
            ...
            public void ShowMaestroPairingPin()
            {
                ...
                {
                    DialogManager.Instance.ShowMessage("Maestro Unavailable", "Enable Maestro first to generate a pairing PIN.");
                    return;
                }
                DialogManager.Instance.ShowMessage("Maestro Pairing PIN", $"{maestro.PairingToken}\\n\\nDo not show this PIN to anyone you do not trust.");
            }
